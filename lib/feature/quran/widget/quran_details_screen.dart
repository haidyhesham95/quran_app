      ...
      children: [
        Positioned.fill(
         child: SizedBox(
            height: size.height,
            width: size.width,
             child: Image.asset(Assets.imagesCover1,height: double.infinity,width: double.infinity,fit: BoxFit.fill,opacity:AlwaysStoppedAnimation(0.8))),
       ),
        Scaffold(
                ...
                itemBuilder: (context, index) {
                  return SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Center(child: Text(quranDetails[index],style: Styles.textStyleName22,)),
                    ),
                  );
                },
              ))
